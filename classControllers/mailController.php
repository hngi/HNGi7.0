  ...
  try {
    ...
    <td style='padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;'>
                       ...
                       <p>You recently requested to reset your password for your HNGi account.<br>
                        Use the button below to reset it.<br>
                        This password reset is only valid for the next 24 hours.
                        Reset your password $fullname<br><br></p>

                       <p>For security, If you did not request a password reset, please ignore this email or contact support ( http://hngi7.hng.tech/contactform.php ) if you have questions.</p>
                     ...
                     <p> Thanks,<br>
                      ...
                      $fullname <br> <a href='http://hngi7.hng.tech/admin_login.php'>Follow this link to login</a></p>
                      </td>
                  </tr>
<tr>
<td bgcolor='#808080' style='padding: 30px 30px 30px 30px;'>
