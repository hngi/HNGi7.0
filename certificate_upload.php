...
$data = $sponsors->getAllProcessindRequest();
$status = $sponsors->processing();
...
if (isset($_GET['fileId'])) {
  if (isset($_POST['uploadfile'])) {
    ...
    if (move_uploaded_file($_FILES["file"]["tmp_name"], $target_file)) {
      $insert = $database->query("UPDATE certificate_request SET file = '$target_file' WHERE id = '$id' ");
      $_SESSION['file'] = "<h6 style='color: green'>File was uploaded</h6>";
        ...
        <div class="row">
          <div class="col-md-6">
            <form method="post" enctype="multipart/form-data">
              ...
              <button type="submit" class="btn btn-primary" name="uploadfile">Upload certificate</button>


              <a href="processing_request" class="btn mb-4" style="background: gray; color:#fff;">cancel</a>
            </form>
          </div>
