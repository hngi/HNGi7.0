  ...
  <div class="container-fluid mt-5 mentor">
    <div class="row text-center">
      ...
      <div class="col-xl-3 col-sm-6 mb-3 mentor_card">
        <div class="bg-white rounded  py-4 px-4"><img src="<?= $ment['photo_url'] ;  ?>" alt="" width="100%"
            height="auto" class="img-fluid rounded-circle mb-3  ">
          <h6 class="mb-2 hew"><?= $ment['name']; ?></h6>
          <span class="text-muted"><?= $ment['area_of_expertise'] ; ?></span>
          <ul class="social mb-0 list-inline mt-2">
            <li class="list-inline-item"><a href="<?= $ment['twitter_url'] ;  ?>"
                class="social-link s-link<?= $counter ;?>"><i class="fab fa-twitter"></i></a>
            </li>
            <li class="list-inline-item"><a href="<?= $ment['fb_url'] ;  ?>"
                class="social-link s-link<?= $counter ; ?>"><i class="fab fa-facebook"></i></a></li>
            <?php
                            ...
                            ?>
            <li class="list-inline-item"><a href="<?= $portfolio_link;  ?>"
                class="social-link s-link<?= $counter ;?>"><i
