        ...
        <section class="freq">
            <div class="container">
                <div class="wrap">          
                        ...
                        <p id="Menu1" style="display: none;" class="paragraph">The internship is going to start early next year and it kicks off with a pre-internship program which involves students from all over the country registering with start.ng before the main internship .</p>
