                    ...
                    <div class="main-fifth-row text-align">
                        <div class="row">
                            <div class="text-center text-md-left col-12 col-md-6 col" style="padding-top: 35px;">
                                ...
                                <p class="content">The HNG Internship is a 3-months remote internship designed to find and develop the most talented software developers. Everyone is welcoming to participate(there is no entrance exam). Anyone can log into the internship
                                    using their laptop. Each week, we give tasks.</p>
              ...
              <a href="join-intern" id="butt">Get Started</a>
                            ...
                            <div class="col-12 mt-md-5 mt-lg-0 col-md-6 ">
                                <div class="row">
                                    <div class="col-12 myImage" style="padding-bottom: 6em; padding-top: 12px">
                                        <img style="width:100%;" src="https://res.cloudinary.com/chibuogwu/image/upload/v1570730626/img1_cpa8nj.png">
                                    </div>
                                </div>
                    ...
                    <div class="container-fluid mt-2" id="wrapper">
                        <div class="row">
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12 mt-5 mb-5">
                                                <div class="row">
                                                    <div class="col-2">
                                                        <img src="https://res.cloudinary.com/oderinde5/image/upload/v1570573242/samples/frontend_hzyzio.png" width="50px" class="img-fluid">
                                                    </div>
                                                    <div class="col-10">
                                                        <h5>FRONT END</h5>
                                                ...
                                                <div class="row">
                                                    <div class="col-2">
                                                        <img src="https://res.cloudinary.com/oderinde5/image/upload/v1570573242/samples/backend_orn4az.png" width="50px" class="img-fluid">
                                                    </div>
                                                    <div class="col-10">
                                                        <h5>BACK END</h5>
                                                        <P>Put your backenend skills to test and sharpen it by building scalable, logic driven applications with world class technologies.</P>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-2">
                                                        <img src="https://res.cloudinary.com/oderinde5/image/upload/v1570573242/samples/ml_sdviij.png" width="30px" class="img-fluid ml-2">
                                                    </div>
                                                    <div class="col-10">
                                                        <h5>MACHINE LEARNING</h5>
                                                        <P>Develop programs that can access data and utilize it to automatically learn and improve from experience
                                                        </P>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-2">
                                                        <img src="https://res.cloudinary.com/oderinde5/image/upload/v1570573242/samples/ui-ux_xq64bx.png" width="50px" class="img-fluid">
                                                    </div>
                                                    <div class="col-10">
                                                        <h5>UI / UX DESIGN</h5>
                                                        <P>Put your UX/UI Design skills to test and sharpen it as you design exciting User Interfaces for great User Experience.</P>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-2">
                                                        <img src="https://res.cloudinary.com/oderinde5/image/upload/v1570573242/samples/dm_bxzzr2.png" width="50px" class="img-fluid">
                                                    </div>
                                                    <div class="col-10">
                                                ...
                                                <div class="accordion" id="accordionExample">
                                                    <div class="card" id="card0">
                                                        <div class="card-header" id="headingOne">
                                                            <h2 class="mb-0">
                                                                <img onclick="activeDropDown('headingOne')" class="btn" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" src="https://res.cloudinary.com/oderinde5/image/upload/v1570573242/samples/arrow_lmoyy2.png" class="arrow1">
                                                                <button onclick="activeDropDown('headingOne')" class="btn btn-link collapsed buttonTwo" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne"> Frontend
                              Development </button>
                                                            </h2>
                                                        </div>
                                                    ...
                                                    <div class="card" id="card1">
                                                        <div class="card-header" id="headingTwo">
                                                            <h2 class="mb-0">
                                                                <img onclick="activeDropDown('headingTwo')" class="btn collapsed buttonTwo" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" src="https://res.cloudinary.com/oderinde5/image/upload/v1570573242/samples/arrow_lmoyy2.png">
                                                                <button onclick="activeDropDown('headingTwo')" class="btn btn-link collapsed buttonTwo" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo"> Backend
                              Development </button>
                                                            </h2>
                                                        </div>
                                                    ...
                                                    <div class="card" id="card2">
                                                        <div class="card-header" id="headingThree">
                                                            <h2 class="mb-0">
                                                                <img onclick="activeDropDown('headingThree')" class="btn collapsed buttonThree" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree" src="https://res.cloudinary.com/oderinde5/image/upload/v1570573242/samples/arrow_lmoyy2.png">
                                                                <button onclick="activeDropDown('headingThree')" class="btn btn-link collapsed buttonThree" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree"> Machine
                              Learning </button>
                                                            </h2>
                                                        </div>
                                                    ...
                                                    <div class="card" id="card3">
                                                        <div class="card-header" id="headingFour">
                                                            <h2 class="mb-0 ">
                                                                <img onclick="activeDropDown('headingFour')" class="btn collapsed buttonFour" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour" src="https://res.cloudinary.com/oderinde5/image/upload/v1570573242/samples/arrow_lmoyy2.png">
                                                                <button onclick="activeDropDown('headingFour')" class="btn btn-link collapsed buttonFour" type="button" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour"> UI/UX
                              Design
                            </button>
                                                            </h2>
                                                        </div>
                                                    ...
                                                    <div class="card" id="card4">
                                                        <div class="card-header" id="headingFive">
                                                            <h2 class="mb-0">
                                                                <img onclick="activeDropDown('headingFive')" class="btn collapsed buttonFive" data-toggle="collapse" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive" src="https://res.cloudinary.com/oderinde5/image/upload/v1570573242/samples/arrow_lmoyy2.png">
                                                                <button onclick="activeDropDown('headingFive')" class="btn btn-link collapsed buttonFive" type="button" data-toggle="collapse" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive"> Digital
                              Marketing </button>
                                                            </h2>
                                                        </div>
                            ...
                            <div class="container">
                                <h4 class="bass" style="margin-top: 4em; margin-left: 10px; text-align: center; color: darkblue; font-size: 24px;">Our Dedicated Mentors
                                </h4>
                                <div class="row" style="margin-top: 2em; margin-left: -41px; text-align: center;">
                                    <div class="col-6 col-lg-3">
                                        <img style="width: 150px; height: 150px; border-radius: 50%;" src="https://res.cloudinary.com/chibuogwu/image/upload/v1570730807/IMG2_uiu3fj.png">
                                        <p style=" color: #8898AA;">Ryan Thompson
                                            <br>web Developer</p>
                                    </div>
                                    <div class="col-6 col-lg-3">
                                        <img style="width: 150px; height: 150px; border-radius: 50%;" src="https://res.cloudinary.com/chibuogwu/image/upload/v1570730833/IMG4_kvttgt.png">
                                        <p style=" color: #8898AA;">Romina Hadid
                                            <br>Marketing Strategist</p>
                                    </div>
                                    <div class="col-6 col-lg-3">
                                        <img style="width: 150px; height: 150px; border-radius: 50%;" src="https://res.cloudinary.com/chibuogwu/image/upload/v1570730816/IMG3_cerrem.png">
                            ...
                            <div id="leash" class="container-fluid mb-4 px-4">
                                <div class="row" style="padding-top: 4em;">
                                    <div class="col-12 text-center text-md-left  col-md-6" style="padding-top: 5em;">
                                        <h4 style="color: darkblue;letter-spacing: 1.2px; font-weight: bold; font-size: 24px;">HNG 6.0 Internship
                                        </h4>
                                        <p class="lee" style="line-height: 0.4px; color: #8898AA;"><i>.....the journey so far</i></p>
                                        <p style="color: #333333; font-style: normal; letter-spacing: 1.1px; padding-top: 20px;">The HNG 6.0 Internship commenced 9th September, 2019 and ended 17th November, 2019.</p>

                                        <p id="jz">
                                            A well-planned, coordinated event where young talented folks from across the globe participated remotely and were involved in learning key skills needed to becoming the best globally in programming, design thinking, machine learning and digital marketing.
                                        </p>

                                        <div class="mb-3" style="padding-top: 35px;">
                                            <a style="color:#00AEFF;" href="hng6.php">

                                                <i class="fa fa-angle-right px-1" style="color:#00AEFF; border:1px solid #00AEFF; background-color: white; border-radius: 50%; "></i>Learn more
                                            </a>
                                        </div>
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <img style="width: 100%;" src="https://res.cloudinary.com/chibuogwu/image/upload/v1570730841/IMG5_prmueb.png">
                                    </div>
                                </div>
                            </div>
